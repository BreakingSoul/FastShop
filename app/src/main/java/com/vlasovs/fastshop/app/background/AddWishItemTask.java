...
public class AddWishItemTask extends AsyncTask <Integer, Void, Void> {

    public OnWishListAddedResponse delegate;
        ...
        protected Void doInBackground(Integer... integers) {
            ...
            try{
                ...
                idForQuery.put("itemid", String.valueOf(integers[1]));
            ...
            Request request = new Request.Builder()
                    .url("http://192.168.1.43/addwishitem.php")
